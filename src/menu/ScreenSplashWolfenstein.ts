...
export class ScreenSplashWolfenstein extends Screen {
    ...
    constructor(props: any) {
        super("screen_splash_wolfenstein", props);
    ...
    render(c: CanvasRenderingContext2D, delta: number): void {
        ...
        let img = Resources.instance.data.textures.screen_splash_wolfenstein;
